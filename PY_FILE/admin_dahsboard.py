...
class Ui_admin_dashboard(object):
    ...
    def setupUi(self, admin_dashboard):
        ...
        self.lbl_dept_txt.setGeometry(QtCore.QRect(20, 160, 222, 51))
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.lbl_sem.setGeometry(QtCore.QRect(630, 160, 222, 51))
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        # self.dept_combo.activated.connect(self.openwindow)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.admin_tab.setCurrentIndex(1)
    ...
    def upload_File_it(self, file_path, sem_data):
        ...
        try:
            ...
            query = ("SELECT * FROM it_exel_file where sem ='" +
                     sem_data+"' and file_path ='"+file_path+"'")
            ...
            if result:
                ...
                mycursor.execute(
                    "insert into it_exel_file values('"+sem_data+"','"+file_path+"')")
                print("hello")
                self.mydb.commit()
                self.message("CONGRATULATION!!",
                             "YOUR FILE IS BEAN UPLOADED!!")
    ...
    def upload_File_cs(self, file_path, sem_data):
        ...
        try:
            print("hi")
            mycursor = self.mydb.cursor()
            query = ("SELECT * FROM cs_exel_file where sem ='" +
                     sem_data+"' and file_path ='"+file_path+"'")
            mycursor.execute(query)
            result = mycursor.fetchone()
            print("hello")
            ...
            if result:
                ...
                mycursor.execute(
                    "insert into cs_exel_file values('"+sem_data+"','"+file_path+"')")
                print("hello")
                self.mydb.commit()
                self.message("CONGRATULATION!!",
                             "YOUR FILE IS BEAN UPLOADED!!")
    ...
    def upload_File_extc(self, file_path, sem_data):
        ...
        try:
            print("hi")
            mycursor = self.mydb.cursor()
            query = ("SELECT * FROM extc_exel_file where sem ='" +
                     sem_data+"' and file_path ='"+file_path+"'")
            mycursor.execute(query)
            result = mycursor.fetchone()
            print("hello")
            ...
            if result:
                ...
                mycursor.execute(
                    "insert into extc_exel_file values('"+sem_data+"','"+file_path+"')")
                print("hello")
                self.mydb.commit()
                self.message("CONGRATULATION!!",
                             "YOUR FILE IS BEAN UPLOADED!!")
    ...
    def upload_File_mech(self, file_path, sem_data):
        ...
        try:
            print("hi")
            mycursor = self.mydb.cursor()
            query = ("SELECT * FROM mechanical_exel_file where sem ='" +
                     sem_data+"' and file_path ='"+file_path+"'")
            mycursor.execute(query)
            result = mycursor.fetchone()
            print("hello")
            ...
            if result:
                ...
                mycursor.execute(
                    "insert mechanical_exel_file values('"+sem_data+"','"+file_path+"')")
                print("hello")
                self.mydb.commit()
                self.message("CONGRATULATION!!",
                             "YOUR FILE IS BEAN UPLOADED!!")
    ...
    def upload_File_biomed(self, file_path, sem_data):
        ...
        try:
            print("hi")
            mycursor = self.mydb.cursor()
            query = ("SELECT * FROM biomed_exel_file where sem ='" +
                     sem_data+"' and file_path ='"+file_path+"'")
            mycursor.execute(query)
            result = mycursor.fetchone()
            print("hello")
            ...
            if result:
                ...
                mycursor.execute(
                    "insert into biomed_exel_file values('"+sem_data+"','"+file_path+"')")
                print("hello")
                self.mydb.commit()
                self.message("CONGRATULATION!!",
                             "YOUR FILE IS BEAN UPLOADED!!")
    ...
    def set_file(self):
        ...
        Fname = QFileDialog.getOpenFileName(
            None, "open File", "", "All File (*);;Exel File (*.xlsx)")
        file_path = Fname[0]
        if Fname:
